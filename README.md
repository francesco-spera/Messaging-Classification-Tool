Tale tool è stato realizzato per la classificazione degli stream TCP di oggetti (immagini, video, audio e file) ottenuti a partire dai servizi di Instant Messaging.
